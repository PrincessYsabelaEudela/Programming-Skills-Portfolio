...
glossary = {'String': 'It is a data type, these are series of characters',
...
for key, value in glossary.items(): #iterates or loops the key and value pairs in the dictionary and prints them
    print(key,':', value, '\n') 
