...
for i in dinner: #for loop iterates over the list one by one with the message
...
for i in dinner:
    print ("Hello", i + ", I am inviting you for a dinner this Saturday") #looping again with the second set of invitation messages